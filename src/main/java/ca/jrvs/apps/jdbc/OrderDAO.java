...
public class OrderDAO extends DataAccessObject<Order> {
    ...
    private static String GET_BY_ID = "SELECT c.first_name, c.last_name, c.email, o.order_id, o.creation_date," +
            ...
            "p.variety, p.price FROM orders AS o JOIN customer AS c ON o.customer_id = c.customer_id JOIN " +
            "salesperson AS s ON o.salesperson_id = s.salesperson_id JOIN order_item AS ol ON " +
            "ol.order_id = o.order_id JOIN product AS p ON ol.product_ID = p.product_id WHERE o.order_id = ?";
